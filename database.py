...
class Suscripcion(Base):
    ...
    onesignal_user_id = Column(String(255), nullable=True, index=True)  # ✅ NUEVO: ID de usuario OneSignal
    token_fcm = Column(String(255), nullable=True)  # Ahora opcional si usas OneSignal
